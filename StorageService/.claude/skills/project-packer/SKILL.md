...
python3 .claude/skills/project-packer/scripts/merge.py . -o /tmp/project.txt

# 2. Анонимизировать
python3 .claude/skills/project-packer/scripts/sanitize.py /tmp/project.txt -o /tmp/clean.txt
